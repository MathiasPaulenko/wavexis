"""Interactive config generator for browsix.yaml."""
...
def generate_config(
    ...
    """Generate a browsix YAML config from a template with optional overrides.
...
def interactive_init(
    ...
    """Run an interactive wizard to generate a browsix.yaml config.
    ...
    """
    output_fn("browsix init — generate a browsix.yaml config\n")
